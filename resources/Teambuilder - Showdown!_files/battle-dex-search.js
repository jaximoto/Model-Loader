...
var tags=Dex.species.get(Dex.species.get(id).baseSpecies).tags;
...
filters.length;_i18++){var _ref19=filters[_i18];var filterType=_ref19[0];var value=_ref19[1];
switch(filterType){
case'pokemon':
if(!Dex.hasAbility(this.dex.species.get(value),ability.name))return false;
break;
...
filters.length;_i28++){var _ref20=filters[_i28];var filterType=_ref20[0];var value=_ref20[1];
switch(filterType){
case'type':
