...
(_this$scene$$frame3=_this.scene.$frame)==null?void 0:_this$scene$$frame3.css('margin-bottom',''+(360*scale-360)+'px');

}else{var _this$scene$$frame4,_this$scene$$frame5;
(_this$scene$$frame4=_this.scene.$frame)==null?void 0:_this$scene$$frame4.css('transform','none');

(_this$scene$$frame5=_this.scene.$frame)==null?void 0:_this$scene$$frame5.css('margin-bottom','0');
}
...
if(_ruleName==='Exact HP Mod')this.reportExactHP=true;
